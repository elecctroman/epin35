    ...
    <main class="admin-main">
      <header class="admin-topbar">
        ...
        <div class="admin-user">
          ...
          <div class="admin-actions">
            <a class="btn-muted" href="<?= Helpers::baseUrl('/') ?>" target="_blank" rel="noopener">Mağazayı Gör</a>
      ...
      <div class="admin-toolbar">
        <div>
          ...
          <span class="badge">FraudShield Aktif</span>
        </div>
        <div class="admin-toolbar-links">
          <a href="<?= Helpers::baseUrl('admin/orders') ?>">Bekleyen Siparişler</a>
          <a href="<?= Helpers::baseUrl('admin/tickets') ?>">Destek Kuyruğu</a>
          <a href="<?= Helpers::baseUrl('admin/settings') ?>">Ayarlar</a>
        </div>
      </div>
